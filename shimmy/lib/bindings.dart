...
class NeutronPlatform {
  ...
  late final _nt_device_enum_countPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<NtDeviceEnum>,
  ...
  ffi.Pointer<ffi.Int> nt_device_enum_query(
    ffi.Pointer<NtDeviceEnum> self,
    NtDeviceQuery query,
  ) {
  ...
  late final _nt_device_enum_queryPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Int> Function(ffi.Pointer<NtDeviceEnum>,
  ...
  late final ffi.Pointer<ffi.Int> _NT_BEGIN_DECLS =
      _lookup<ffi.Int>('NT_BEGIN_DECLS');

  int get NT_BEGIN_DECLS => _NT_BEGIN_DECLS.value;

  set NT_BEGIN_DECLS(int value) => _NT_BEGIN_DECLS.value = value;
...
class _NtDeviceQuery extends ffi.Struct {
  ...
  external ffi.Pointer<ffi.Int> parameters;
}
...
class _NtDeviceEnum extends ffi.Struct {
  ...
  external ffi.Pointer<ffi.Int> added;

  external ffi.Pointer<ffi.Int> removed;

  external ffi.NativeFunction<
      ffi.NativeFunction<
              ffi.Int Function(ffi.Pointer<_NtDeviceEnum>, NtDeviceQuery)>
          Function(ffi.Pointer<ffi.Int>)> size_t;
