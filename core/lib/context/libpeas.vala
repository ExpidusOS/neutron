namespace Neutron {
  public sealed class PeasContext : Context {
    ...
    construct {
      ...
      this._plugin_engine.add_search_path(LIBDIR + "/neutron/plugins", DATADIR + "/neutron/plugins");

#if TARGET_SYSTEM_WINDOWS
      var prefix = GLib.Win32.get_package_installation_directory_of_module(null);
      this._plugin_engine.add_search_path(GLib.Path.build_filename(prefix, "lib", "neutron", "plugins"), GLib.Path.build_filename(prefix, "share", "neutron", "plugins"));
#endif
